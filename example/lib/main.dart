...
class CustomPicker extends dt.CommonPickerModel {
  String digits(int value, int length) {
    return '$value'.padLeft(length, "0");
  }

  CustomPicker({DateTime? currentTime, dt.LocaleType? locale})
      : super(locale: locale) {
      ...
      body: Center(
        child: Column(
          children: <Widget>[
            TextButton(
                onPressed: () {
                  dt.DatePicker.showDatePicker(context,
                    ...
                    print('confirm $date');
                  }, currentTime: DateTime.now(), locale: dt.LocaleType.en);
                },
                child: Text(
            ...
            TextButton(
                onPressed: () {
                  dt.DatePicker.showTimePicker(context, showTitleActions: true,
                      onChanged: (date) {
                    print('change $date in time zone ' +
                        date.timeZoneOffset.inHours.toString());
                  }, onConfirm: (date) {
            ...
            TextButton(
                onPressed: () {
                  dt.DatePicker.showTime12hPicker(context,
            ...
            TextButton(
                onPressed: () {
                  dt.DatePicker.showPicker(context, showTitleActions: true,
                      onChanged: (date) {
                    print('change $date in time zone ' +
                        date.timeZoneOffset.inHours.toString());
                  }, onConfirm: (date) {
