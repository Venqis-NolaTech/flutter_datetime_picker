...
import 'package:flutter_datetime_picker/src/datetime_picker_theme.dart' as dt;
...
class _DatePickerRoute<T> extends PopupRoute<T> {
  _DatePickerRoute({
    ...
    BasePickerModel? pickerModel,
        ...
        this.theme = theme ?? dt.DatePickerTheme(),
  ...
  final dt.DatePickerTheme theme;
...
//    print('refreshScrollOffset ${widget.pickerModel.currentRightIndex()}');
  ...
  Widget build(BuildContext context) {
    dt.DatePickerTheme theme = widget.route.theme;
  ...
  Widget _renderPickerView(dt.DatePickerTheme theme) {
  ...
  Widget _renderItemView(dt.DatePickerTheme theme) {
    return Container(
      color: theme.backgroundColor,
  ...
  // Title View
  Widget _renderTitleActionsView(dt.DatePickerTheme theme) {
